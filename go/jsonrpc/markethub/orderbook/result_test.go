...
func TestResultJSONDoesNotExposeVenues(t *testing.T) {
	...
	want := Result{
		...
		SourceVenueCount: 2, Version: 42, Timestamp: 1788512400000000, Synchronized: true,
	}
	data, err := json.Marshal(want)
	if err != nil {
		t.Fatalf("Marshal() error = %v", err)
	}
	wantJSON := `{"ac":"crypto","mt":"spot","s":"BTC/USDC","d":3,"am":"consolidated-depth","b":[{"p":"100","q":"2.5"}],"a":[{"p":"101","q":"3.5"}],"svc":2,"v":42,"ts":1788512400000000,"sync":true}`
